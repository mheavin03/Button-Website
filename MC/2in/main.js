...
(function(){
  ...
  // Default independent gaps for preview (and legacy fallback)
  ...
  function findNextEmptySlot(startPage, startIdx){
    ...
    // none found, create a new page and use first cell
  ...
  function applySettings(){
    // Set independent gaps for preview and legacy fallback
  ...
  applySettings();
  // Build filename from editable H1
  ...
  document.getElementById('exportPDF').addEventListener('click', function(){
    var proposed = getExportFilename('circle-template-3x4.pdf');
